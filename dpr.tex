...
Le développement grandissant de systèmes robotiques autonomes, comme les drones, les bases mobiles et les véhicules autonomes, demande des capacités d'analyse vidéo de plus en plus performantes. Les flux vidéo continus captés par ces plateformes représentent une source considérable de données, dont l'exploitation,  en temps réel ou même en différé, constitue un défi majeur dû aux limitations de la puissance de calcul, d'autonomie et de capacité de stockage des système embarqués. En conséquence, les méthodes traditionnelles d'analyse multimodale, qui combinent à la fois le traitement d'images et le traitement de l’audio, demeurent difficilement applicables sur des dispositifs robotisés contraints en ressources.
